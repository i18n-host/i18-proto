...
impl ::pb_jelly::Message for UpdateLi {
  ...
  fn compute_size(&self) -> usize {
    ...
    size += ::pb_jelly::helpers::compute_size_scalar::<u32>(&self.lang, 2, ::pb_jelly::wire_format::Type::Varint);
  ...
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ...
    ::pb_jelly::helpers::serialize_scalar::<W, u32>(w, &self.lang, 2, ::pb_jelly::wire_format::Type::Varint)?;
...
impl ::pb_jelly::Message for RelTxt {
  ...
  fn compute_size(&self) -> usize {
    let mut size = 0usize;
    size += ::pb_jelly::helpers::compute_size_scalar::<::std::string::String>(&self.rel, 1, ::pb_jelly::wire_format::Type::LengthDelimited);
    size += ::pb_jelly::helpers::compute_size_scalar::<::std::string::String>(&self.txt, 2, ::pb_jelly::wire_format::Type::LengthDelimited);
    size
  }
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ::pb_jelly::helpers::serialize_scalar::<W, ::std::string::String>(w, &self.rel, 1, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    ::pb_jelly::helpers::serialize_scalar::<W, ::std::string::String>(w, &self.txt, 2, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    Ok(())
  }
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "RelTxt", 1)?;
          self.rel = val;
        }
        2 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "RelTxt", 2)?;
          self.txt = val;
        }
        _ => {
          ::pb_jelly::skip(typ, &mut buf)?;
...
impl ::pb_jelly::Reflection for RelTxt {
  ...
  fn get_field_mut(&mut self, field_name: &str) -> ::pb_jelly::reflection::FieldMut<'_> {
    match field_name {
      "rel" => {
        ::pb_jelly::reflection::FieldMut::Value(&mut self.rel)
      }
      "txt" => {
        ::pb_jelly::reflection::FieldMut::Value(&mut self.txt)
      }
...
impl ::pb_jelly::Message for TranLi {
  ...
  fn compute_size(&self) -> usize {
    ...
    for val in &self.li {
      size += ::pb_jelly::helpers::compute_size_field::<RelTxt>(val, 3, ::pb_jelly::wire_format::Type::LengthDelimited);
    }
    size
  }
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ...
    for val in &self.li {
      ::pb_jelly::helpers::serialize_field::<W, RelTxt>(w, val, 3, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    }
    Ok(())
  }
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "TranLi", 1)?;
          self.from_lang = val;
        }
        2 => {
          ::pb_jelly::helpers::deserialize_packed::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "TranLi", 2, &mut self.to_lang_li)?;
        }
        3 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, RelTxt>(buf, typ, "TranLi", 3)?;
          self.li.push(val);
        }
        _ => {
          ::pb_jelly::skip(typ, &mut buf)?;
...
impl ::pb_jelly::Message for Dict {
  ...
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "Dict", 1)?;
          self.lang = val;
        }
        2 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "Dict", 2)?;
          self.from_word_li.push(val);
        }
        3 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "Dict", 3)?;
...
impl ::pb_jelly::Message for Term {
  ...
  fn compute_size(&self) -> usize {
    ...
    for val in &self.dict_li {
      size += ::pb_jelly::helpers::compute_size_field::<Dict>(val, 4, ::pb_jelly::wire_format::Type::LengthDelimited);
    }
    size
  }
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ...
    for val in &self.dict_li {
      ::pb_jelly::helpers::serialize_field::<W, Dict>(w, val, 4, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    }
    Ok(())
  }
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "Term", 1)?;
          self.lang = val;
        }
        2 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "Term", 2)?;
          self.from_word_li.push(val);
        }
        3 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "Term", 3)?;
          self.to_word_li.push(val);
        }
        4 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, Dict>(buf, typ, "Term", 4)?;
...
impl ::pb_jelly::Message for Tran {
  ...
  fn compute_size(&self) -> usize {
    ...
    for val in &self.tran_li {
      size += ::pb_jelly::helpers::compute_size_field::<TranLi>(val, 2, ::pb_jelly::wire_format::Type::LengthDelimited);
    }
    for val in &self.term_li {
      size += ::pb_jelly::helpers::compute_size_field::<Term>(val, 3, ::pb_jelly::wire_format::Type::LengthDelimited);
    }
    size
  }
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ...
    for val in &self.tran_li {
      ::pb_jelly::helpers::serialize_field::<W, TranLi>(w, val, 2, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    }
    for val in &self.term_li {
      ::pb_jelly::helpers::serialize_field::<W, Term>(w, val, 3, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    }
    Ok(())
  }
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, UpdateLi>(buf, typ, "Tran", 1)?;
          self.update_li.push(val);
        }
        2 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, TranLi>(buf, typ, "Tran", 2)?;
          self.tran_li.push(val);
        }
        3 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, Term>(buf, typ, "Tran", 3)?;
...
impl ::pb_jelly::Message for TranResult {
  ...
  fn compute_size(&self) -> usize {
    let mut size = 0usize;
    size += ::pb_jelly::helpers::compute_size_scalar::<u64>(&self.id, 1, ::pb_jelly::wire_format::Type::Varint);
    size += ::pb_jelly::helpers::compute_size_scalar::<u32>(&self.code, 2, ::pb_jelly::wire_format::Type::Varint);
    size += ::pb_jelly::helpers::compute_size_scalar::<::std::string::String>(&self.rel, 3, ::pb_jelly::wire_format::Type::LengthDelimited);
    size += ::pb_jelly::helpers::compute_size_scalar::<u32>(&self.lang, 4, ::pb_jelly::wire_format::Type::Varint);
    size += ::pb_jelly::helpers::compute_size_scalar::<::std::string::String>(&self.msg, 5, ::pb_jelly::wire_format::Type::LengthDelimited);
    size
  }
  fn serialize<W: ::pb_jelly::PbBufferWriter>(&self, w: &mut W) -> ::std::io::Result<()> {
    ::pb_jelly::helpers::serialize_scalar::<W, u64>(w, &self.id, 1, ::pb_jelly::wire_format::Type::Varint)?;
    ::pb_jelly::helpers::serialize_scalar::<W, u32>(w, &self.code, 2, ::pb_jelly::wire_format::Type::Varint)?;
    ::pb_jelly::helpers::serialize_scalar::<W, ::std::string::String>(w, &self.rel, 3, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    ::pb_jelly::helpers::serialize_scalar::<W, u32>(w, &self.lang, 4, ::pb_jelly::wire_format::Type::Varint)?;
    ::pb_jelly::helpers::serialize_scalar::<W, ::std::string::String>(w, &self.msg, 5, ::pb_jelly::wire_format::Type::LengthDelimited)?;
    Ok(())
  }
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u64>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "TranResult", 1)?;
          self.id = val;
        }
        2 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "TranResult", 2)?;
          self.code = val;
        }
        3 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "TranResult", 3)?;
          self.rel = val;
        }
        4 => {
          let val = ::pb_jelly::helpers::deserialize_known_length::<B, u32>(buf, typ, ::pb_jelly::wire_format::Type::Varint, "TranResult", 4)?;
          self.lang = val;
        }
        5 => {
          let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, ::std::string::String>(buf, typ, "TranResult", 5)?;
          self.msg = val;
        }
        _ => {
          ::pb_jelly::skip(typ, &mut buf)?;
